                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                                ...
                                if(check != {}) {
                                  Navigator.pushNamed(context, '/home2', arguments: {'currentuser' : currentuser} )
                                  }
                                },
                                                          child: circleButton(constr,sizeWidth/200,sizeWidth/100,"assets/google.png"),
                                                        ),
                          ...
                          child: InkWell(
                            onTap: () async {
                             if(nameController.text == ""  || passwordController.text == "" || emailController.text == "") {error.value = true;}
                              ...
                              if(check == 'userExists') Navigator.pushNamed(context, '/home2', arguments: {'currentuser' : nameController.text} );
